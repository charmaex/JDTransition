...
struct JDAnimationSlideFrom {
    ...
    static func left(inWindow window: UIView, fromVC: UIViewController, toVC: UIViewController, duration: TimeInterval, options: UIViewAnimationOptions?, completion: @escaping (Bool) -> Void) {
        animate(in: window, fromVC: fromVC, toVC: toVC, duration: duration, options: options, direction: .left, completion: completion)
    }

    static func right(inWindow window: UIView, fromVC: UIViewController, toVC: UIViewController, duration: TimeInterval, options: UIViewAnimationOptions?, completion: @escaping (Bool) -> Void) {
        animate(in: window, fromVC: fromVC, toVC: toVC, duration: duration, options: options, direction: .right, completion: completion)
    }

    static func bottom(inWindow window: UIView, fromVC: UIViewController, toVC: UIViewController, duration: TimeInterval, options: UIViewAnimationOptions?, completion: @escaping (Bool) -> Void) {
        animate(in: window, fromVC: fromVC, toVC: toVC, duration: duration, options: options, direction: .bottom, completion: completion)
    }

    static func top(inWindow window: UIView, fromVC: UIViewController, toVC: UIViewController, duration: TimeInterval, options: UIViewAnimationOptions?, completion: @escaping (Bool) -> Void) {
    ...
    private static func animate(in window: UIView, fromVC: UIViewController, toVC: UIViewController, duration: TimeInterval, options opt: UIViewAnimationOptions?, direction: Direction, completion: @escaping (Bool) -> Void) {
